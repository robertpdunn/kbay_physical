...
```{r}
reef25 <- bind_rows(reef25_2014, reef25_2015)
reef44 <- bind_rows(reef44_2014, reef44_2015)
reef42 <- bind_rows(reef42_2014, reef42_2015)
reefHIMB <- bind_rows(reefHIMB_2014, reefHIMB_2015)
```
